...
test("East Penn: the AVR table's kilowatt-hours and the 8GGC2's, a '12-Volts' voltage and an 'A.H.' capacity as gaps, and a bare 'Rated Capacity' set aside", () => {
  ...
  // Its 'Rated Capacity' is a bare 1235 in a column whose unit the table does not say; the shared rule is kept off it.
  assert.equal(gap(avr.gaps, "battery.capacity")?.claims, 0);
