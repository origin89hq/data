/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: d1679399ab7e9af4ffd708ef105d94e1)
// Runtime types generated with workerd@1.20260908.1 2026-09-09 nodejs_compat
interface __BaseEnv_Env {
	ARCHIVE: R2Bucket;
	WORK: Queue;
	SIGN_IN_CHECKS: RateLimit;
	AI: Ai;
	SITE: Fetcher;
	GITHUB_CLIENT_ID: "Iv23liFkUtlIH9Q8Xc1h";
	CONTROL_TOKEN: string;
	GITHUB_CLIENT_SECRET: string;
	SELLER_CRAWL: Workflow<Parameters<import("./src/index").SellerCrawl['run']>[0]['payload']>;
	PAGE_CRAWL: Workflow<Parameters<import("./src/index").PageCrawl['run']>[0]['payload']>;
	MANUFACTURER_CRAWL: Workflow<Parameters<import("./src/index").ManufacturerCrawl['run']>[0]['payload']>;
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "GITHUB_CLIENT_ID" | "CONTROL_TOKEN" | "GITHUB_CLIENT_SECRET">> {}
}
declare module "*.css" {
	const value: string;
