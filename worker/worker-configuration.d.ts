/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 0f387dfc1f9451a46095da662e1a2a2d)
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "CONTROL_TOKEN">> {}
}
declare module "*.css" {
	const value: string;
